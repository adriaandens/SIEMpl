...
ok($event->{request} eq 'GET /wp-includes/wlwmanifest.xml', 'The request is corect');
...
ok($event->{http_useragent} eq "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36", 'The User agent is correct');
